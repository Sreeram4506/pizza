      ...
      case 'social':
        return (
          <div className="bg-white rounded-[3rem] p-24 border border-[rgba(26,20,16,0.06)] text-center shadow-sm">
            ...
            <h3 className="text-3xl font-display font-black italic text-[#1A1410] mb-4">Social Synergy</h3>
            ...
            <div className="mt-10">
              <span className="inline-block px-8 py-3 bg-[#FAFAF8] text-[#9B8D74] font-black text-[10px] uppercase tracking-[0.3em] rounded-2xl border border-[rgba(26,20,16,0.06)] italic">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-mono text-[9px] font-black uppercase tracking-[0.3em] text-ember-600">Growth Orchestration</span>
          </div>
        ...
        <div className="flex p-1.5 bg-white rounded-[1.5rem] border border-[rgba(26,20,16,0.06)] overflow-x-auto scrollbar-hide shadow-sm backdrop-blur-xl bg-white/90">
          {['email', 'promotions', 'social'].map((tab) => (
            <button
              ...
              className={`px-8 py-3 text-[10px] font-black uppercase tracking-widest transition-all rounded-xl whitespace-nowrap ${activeTab === tab
